          ...
          <register.Col className='mx-auto' lg={5}>
            <register.Card className='register'>
              <register.Card.Title className='mx-auto'>
                ...
                <div>
                    <p>Name</p>
                  <input onChange={handleIput} value={reg.name} name='name' type="text" className='registerinput' placeholder='Enter name'/>
                  </div>
                  <div>
                    <p>Email</p>
                  <input onChange={handleIput} value={reg.email} name='email' type="text" className='registerinput' placeholder='Enter email address' />
                  </div>
                  <div>
                    <p>Password</p>
                  <input onChange={handleIput} value={reg.password} name='password' type="password" className='registerinput' placeholder='Enter password'/>
                  </div>
                  <div> 
                    <p>Confirm Password</p>
                  <input onChange={handleIput} value={reg.password_confirmation} name='password_confirmation' type="password" className='registerinput' placeholder='Confirm Password'/>
                  </div>
                  ...
                  <div>
                        ...
                        {!loading &&(
                        <button onClick={regSubmit} className='btn btn-primary' id='registerbtn' >Register</button>
                        )}
                    </div>

                    <div>
                        <a id='signuplink' href="/login">Already have an account?</a>
                    </div>
